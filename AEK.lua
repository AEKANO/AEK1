...
os.execute('rm -rf AEK.lua') 
os.execute('wget https://raw.githubusercontent.com/AEKANO/AEK1/main/AEK.lua') 
dofile('AEK.lua') 
...
NameBot = (DevAek:get(AEK..'Aek:NameBot') or 'ايكان')
local AEKTEAM = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
NameBot = (DevAek:get(AEK..'Aek:NameBot') or 'ايكان') 
local AEKTEAM = {"اسمي القميل "..NameBot.." "} 
DevAek2 = math.random(#AEKTEAM) 
Dev_Aek(msg.chat_id_, msg.id_, 1, AEKTEAM[DevAek2] , 1, 'html') 
return false
end
...
Text = "❦ ⁞ اهلا بك عزيزي \n❦ ⁞ عليك اضافة هذا البوت @hmosabot الى مجموعتك\n❦ ⁞ ثم رفعه مشرفا ثم اتبع الاوامر التاليه [هـنـا](https://t.me/SoalfLove)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اضغط هنا لأضافة بوت الهمسه لمجموعتك',url="https://t.me/hmosabot?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hmosabot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source AEK     --
